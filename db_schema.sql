...
CREATE INDEX idx_schemas_fields ON schemas USING GIN(fields);
...
CREATE INDEX idx_invoices_schema_id ON invoices(schema_id);
...
CREATE INDEX idx_extraction_invoice_id ON extraction_results(invoice_id);
...
CREATE INDEX idx_validation_extraction_id ON validation_logs(extraction_result_id);
CREATE INDEX idx_validation_field ON validation_logs(field_name);
